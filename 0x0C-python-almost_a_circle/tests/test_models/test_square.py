...
class TestSquareMethods(unittest.TestCase):
    """Test suite to test the Square class"""
    ...
    def test_new_square_2(self):
        """Test the new square with attributes"""
        new = Square(2, 5, 5, 4)
    ...
    def test_dict_to_json(self):
        """Test Dictionary converted to a JSON string"""
        s1 = Square(2)
    ...
    def test_value_square(self):
        """Test the value passed to the Square"""
        with self.assertRaises(ValueError):
            s1 = Square(-1)
