#!/usr/bin/python3
"""Module for testng Rectangle class"""
import unittest
...
class TestRectangleMethods(unittest.TestCase):
    """Test suite to test the Rectangle class """
    ...
    def test_new_rectangle_2(self):
        """Test the new rectangle with attributes"""
    ...
    def test_is_Base_instance(self):
        """Test if the Rectangle is a Base instance"""
        new = Rectangle(1, 1)
        self.assertEqual(True, isinstance(new, Base))

    def test_incorrect_amount_attrs(self):
        """Test error raised with one argument passed"""
    ...
    def test_access_private_attrs(self):
        """Test access to a private attribute"""
        new = Rectangle(1, 1)
    ...
    def test_str(self):
        """Test the str method return value"""
    ...
    def test_dict_to_json(self):
        """Test the Dictionary converted to JSON string"""
        r1 = Rectangle(2, 2)
